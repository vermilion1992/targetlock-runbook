...
export const CustomBlogCard = () => {
  return (
    <>
      <div className="w-full grid grid-cols-12 rounded-2xl overflow-hidden dark:shadow-dark-md shadow-md mb-6">
        <div className="lg:col-span-6 col-span-12 relative pe-2">
          <Image src={'/images/blog/blog-img6.jpg'} alt="blog" className="w-full max-w-full" />
          <Badge variant={"gray"} className="absolute bottom-6 end-6">
            2 min Read
          </Badge>
          <Image src={'/images/profile/user-4.jpg'} alt="user-image" className="absolute top-6 start-6 w-10 h-10 rounded-full" />
        </div>
        <div className="lg:col-span-6 col-span-12 lg:ps-10 ps-0 pe-6 flex items-center">
          <div className="flex flex-col gap-4">
            <Badge variant={"lightgray"} className="bg-lightemphasis py-1.5" >
              Web Development
            </Badge>
            <h4 className="text-3xl leading-tight font-bold text-link dark:text-white">Building responsive websites: tips and tricks for modern developers</h4>
