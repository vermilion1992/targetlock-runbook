          ...
          <div className="mx-auto flex flex-wrap items-center justify-between">
            ...
            <div className="xl:!block !hidden md:!hidden">
              <div className="flex gap-0 items-center">
                ...
                {activeMode === "light" ? (
                  <div
                    className=" hover:text-primary px-4   dark:hover:text-primary focus:ring-0 rounded-full flex justify-center items-center cursor-pointer text-link dark:text-darklink relative"
                    onClick={toggleMode}
                  >
